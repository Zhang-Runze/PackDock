...
# test_loader = DataListLoader(dataset=test_dataset, batch_size=10, shuffle=False)
    ...
    while not success:
        ...
        if args.save_visualisation:
            ...
            for idx, graph in enumerate(data_list):
                ...
                mol = read_pdb(args.data_dir, graph['name'][0], remove_hs=score_model_args.remove_hs)
                pdb = PDBFile(mol)
                pdb.add(mol, 0, 0)
...
rmsd_df.to_csv("rmsd_pdbbind.csv",index = False)
