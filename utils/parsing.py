...
def parse_train_args():
    ...
    parser.add_argument('--inference_earlystop_metric', type=str, default='valinf_rmsd', help='This is the metric that is addionally used when val_inference_freq is not None')
    parser.add_argument('--inference_earlystop_goal', type=str, default='min', help='Whether to maximize or minimize metric')
    parser.add_argument('--wandb', action='store_true', default=False, help='')
    parser.add_argument('--project', type=str, default='packpocket_train', help='')
    ...
    parser.add_argument('--side_sigma_min', type=float, default=0.0314, help='Minimum sigma for torsional component')
    parser.add_argument('--side_sigma_max', type=float, default=3.14, help='Maximum sigma for torsional component')
